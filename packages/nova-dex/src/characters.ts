...
/**
 * NovaDex — 38 families, 115 evolutionary stages.
 *
 ...
 * Families 8-38 are the same schema at lighter detail — one signature
 * ability instead of several, meant to be filled out with art and full
 * stat/ability balancing in a follow-up pass. Add new families here; keep
 * dexNumber sequential and archetype values in sync with
 * packages/types/src/character.ts#CharacterArchetype.
 */
