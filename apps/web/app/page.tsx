    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.subhead}>
          Nova tracks your real trades and turns your behavior — FOMO, discipline, revenge trading, patience — into
          a roster of characters that level up and evolve as you actually improve. Free to join. No pay-to-win.
        </p>
